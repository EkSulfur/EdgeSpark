...
def main():
    """主函数"""
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='EdgeSpark 训练脚本')
    ...
    parser.add_argument('--batch-size', type=int, default=16, help='批次大小 (default: 16)')
    args = parser.parse_args()
    
    # 创建配置
    config = create_config(epochs=args.epochs)
    ...
    print(f"训练参数: epochs={args.epochs}, lr={args.lr}, batch_size={args.batch_size}")
